...
int GraphAlgorithms::GetShortestPathBetweenVertices(const Graph &graph,
                                                    int vertex_1,
                                                    int vertex_2) {
  return shortest_path_engine_.GetShortestPathBetweenVertices(graph, vertex_1,
                                                              vertex_2);
}
...
TspResult GraphAlgorithms::SolveTravelingSalesmanProblem(
    const Graph &graph, const enum AlgorithmType algorithm_type) {
