...
TEST_F(GraphAlgorithmsShortestPathEngineTest, Test1) {
  ...
  vertex_1 = 1;
  vertex_2 = 6;
  shortest_path = graph_algorithms_.GetShortestPathBetweenVertices(
...
TEST_F(GraphAlgorithmsShortestPathEngineTest, Test6) {
  ...
  std::vector<std::vector<int>> shortest_paths{};
  const std::vector<std::vector<int>> expected_shortest_paths{
      {0, 8, 4, 3, 7, 6}, {8, 0, 4, 5, 7, 8}, {4, 4, 0, 1, 3, 4},
      {3, 5, 1, 0, 4, 3}, {7, 7, 3, 4, 0, 2}, {6, 8, 4, 3, 2, 0}};
...
TEST_F(GraphAlgorithmsShortestPathEngineTest, Test7) {
  ...
  std::vector<std::vector<int>> shortest_paths{};
  const std::vector<std::vector<int>> expected_shortest_paths{
      {0, 45, 45, 10, 25, 0}, {25, 0, 10, 15, 30, 0}, {80, 55, 0, 70, 35, 0},
      {10, 35, 45, 0, 15, 0}, {45, 20, 30, 35, 0, 0}, {48, 23, 33, 38, 3, 0}};
