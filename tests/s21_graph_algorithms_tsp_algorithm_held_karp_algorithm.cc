...
namespace s21 {
class GraphAlgorithmsTspAlgorithmHeldKarpAlgorithmTest
    : public ::testing::Test {
 protected:
  void SetUp() override {}
...
TEST_F(GraphAlgorithmsTspAlgorithmHeldKarpAlgorithmTest, GenerateSubSetsTest) {
  ...
  std::vector<std::set<int>> expected_sub_sets{{},     {1},    {2},   {3},
                                               {1, 2}, {1, 3}, {2, 3}};
...
TEST_F(GraphAlgorithmsTspAlgorithmHeldKarpAlgorithmTest,
       GenerateCombinationTest) {
  std::vector<int> numbers{1, 2, 3};
  std::vector<int> result(3);
  tsp_algorithm_.GenerateCombination(numbers, 0, 0, result);

  std::vector<std::set<int>> expected_combinations{{},  {1},    {1, 2}, {1, 3},
                                                   {2}, {2, 3}, {3}};
